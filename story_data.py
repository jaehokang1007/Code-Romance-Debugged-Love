...
STORY_EVENTS = [
    ...
    # 히든 엔딩 호감도 미달 이벤트
    StoryEvent(
        id="harem_ending_fail",
        chapter=99,
        background="campus_festival",
        characters=["CHOI", "PARK", "JANG", "JASON", "KANG"],
        dialogs=[
            "캠퍼스 중앙 광장, 불꽃놀이가 끝난 후",
            "모든 F&B 멤버들이 함께 불꽃놀이를 보며 즐거운 시간을 보냈다.",
            "최시은: 오늘 정말 재밌었어! 다 같이 보니까 더 좋았던 것 같아.",
            "박이선: 맞아! 우리 F&B 동아리 최고야!",
            "장바영: 좋은 추억이 되었네요. 모두 함께해서 의미가 있었어요.",
            "제이슨: 완전 대박이었어! 내년에도 또 같이 보자!",
            "강재호: 네, 정말 좋았어요. 여러분과 함께해서 더 특별했어요.",
            "",
            "하지만 강재호는 아직 누구와도 특별한 관계로 발전하지는 못했다.",
            "각자의 마음은 있었지만, 서로 확신을 갖기에는 시간이 더 필요했던 것 같다.",
            "",
            "최시은: 그럼 우리 이제 집에 가볼까?",
            "박이선: 응! 오늘 정말 고생했어, 재호야.",
            "장바영: 수고하셨습니다. 내일 동아리방에서 봐요.",
            "제이슨: 재호! 내일 또 만나자!",
            "강재호: 네, 모두 안전하게 들어가세요!",
            "",
            "이렇게 F&B 동아리의 축제는 마무리되었다.",
            "비록 특별한 로맨스는 시작되지 않았지만, 소중한 친구들과의 우정은 더욱 깊어졌다.",
            "",
            "강재호: (혼잣말로) 아직 시작일 뿐이야. 앞으로 더 많은 기회가 있을 거야.",
            "",
            "--- 1년 후 ---",
            "",
            "F&B 동아리는 여전히 활발하게 활동하고 있었다.",
            "강재호는 이제 2학년이 되어 후배들을 가르치는 선배가 되었다.",
            "그리고 동아리 선배들과는 여전히 좋은 관계를 유지하고 있었다.",
            "",
            "최시은: (동아리방에서) 재호야, 이제 너도 선배구나. 어때, 기분이?",
            "강재호: 아직 어색해요. 선배님들처럼 잘할 수 있을지...",
            "박이선: 걱정 마! 너는 충분히 잘하고 있어.",
            "장바영: 체계적으로 후배들을 지도하는 모습이 인상적이에요.",
            "제이슨: 완전 멋진 선배야! 후배들이 너 완전 좋아해!",
            "",
            "강재호는 비록 연인은 생기지 않았지만, 소중한 동료들과 함께 성장해나가고 있었다.",
            "때로는 우정이 사랑보다 더 오래가고 소중할 수도 있다는 것을 깨달았다.",
            "",
            "[일반 엔딩 - 소중한 동료들과 함께]",
            "",
            "* 히든 엔딩을 보려면 모든 캐릭터와의 호감도를 90 이상으로 올려보세요!"
        ],
        choices=[]
    ),
